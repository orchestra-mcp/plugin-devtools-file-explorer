# Orchestra Plugin: devtools-file-explorer
...
```bash
go install github.com/orchestra-mcp/plugin-devtools-file-explorer/cmd@latest
```
...
```yaml
- id: tools.devtools-file-explorer
  binary: ./bin/devtools-file-explorer
  enabled: true
```
